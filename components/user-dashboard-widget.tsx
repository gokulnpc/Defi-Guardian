              ...
              <div className="space-y-3">
                {policies.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500 text-sm">No active coverage policies</p>
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center space-x-3">
                          <span className="text-2xl">{policy.protocolLogo}</span>
                          <div>
                        ...
                        <Badge
                          className={`text-xs border ${getStatusColor(policy.status)}`}
                        >
                  ...
                  stakes.map((stake) => (
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <Badge
                          className={`text-xs border ${getStatusColor(stake.status)}`}
                        >
                          <div className="flex items-center space-x-1">
                ...
                {claims.length === 0 ? (
                  ...
                  claims.map((claim) => (
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center space-x-3">
                          <span className="text-2xl">{claim.protocolLogo}</span>
                          <div>
                            <div className="font-semibold text-gray-900">
                              {claim.protocol}
                            </div>
                        ...
                        <Badge
                          className={`text-xs border ${getStatusColor(claim.status)}`}
                        >
                          <div className="flex items-center space-x-1">
